...
export default function MyTimeOffForm() {
  ...
  const initial = { employeeId: data.employee.id, employeeName: data.employee.fullName, timeOffTypeId: "", timeOffTypeName: "", startDate: "", endDate: "", reason: "", availableBalance: null, status: "Draft" };
