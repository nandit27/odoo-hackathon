      ...
      <div className="min-h-screen bg-slate-100 text-slate-900">
        {!isLogin && currentUser && (
          <header className="border-b border-slate-200 bg-white">
            <nav
              className="flex w-full flex-wrap items-center gap-x-6 gap-y-2 px-4 py-3 sm:px-6 lg:px-8"
              aria-label="Primary navigation"
            >
              <Link
                to={getHomeRoute(currentUser.role)}
                className="border-r border-slate-200 pr-6 text-base font-bold tracking-tight text-slate-950 focus:outline-none focus:ring-2 focus:ring-slate-300"
              >
                PeoplePay360
              </Link>
              ...
              <button
                type="button"
                onClick={signOut}
                className="rounded-md px-3 py-1.5 text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-slate-950"
              >
                Logout
              </button>
            </nav>
        ...
        <main
          className={
            isLogin ? "min-h-screen" : "w-full px-4 py-6 sm:px-6 lg:px-8"
          }
        >
          <Routes>
            {/* Login */}
            ...
            <Route
              path="/employees/new"
              element={protect(<EmployeeFormPage />, "hr")}
            />

            <Route
              path="/employees/:id"
              element={protect(<EmployeeDetails />, "hr")}
            />
            ...
            <Route
              path="/contracts/new"
              element={protect(<ContractFormPage />, "hr")}
            />

            <Route
              path="/contracts/:id"
              element={protect(<ContractDetails />, "hr")}
            />
            ...
            <Route
              ...
              element={protect(<WorkingSchedules />, "hr")}
            />

            <Route
              path="/working-schedules/new"
              element={protect(<WorkingScheduleFormPage />, "hr")}
            />

            <Route
              path="/working-schedules/:id"
              element={protect(<WorkingScheduleDetails />, "hr")}
            />
            ...
            <Route
              path="/attendance/new"
              element={protect(<AttendanceFormPage />, "hr")}
            />

            <Route
              path="/attendance/:id"
              element={protect(<AttendanceDetails />, "hr")}
            />
            ...
            <Route
              path="/timeoff/new"
              element={protect(<TimeOffFormPage />, "hr")}
            />

            <Route
              path="/timeoff/:id"
              element={protect(<TimeOffDetails />, "hr")}
            />
            ...
            <Route
              path="/employees/:employeeId/timeoff"
              element={protect(<TimeOff />, "hr")}
            />

            {/* Time Off Types */}
            <Route
              path="/time-off-types"
              element={protect(<TimeOffTypes />, "hr")}
            />

            <Route
              path="/time-off-types/new"
              element={protect(<TimeOffTypeFormPage />, "hr")}
            />
            ...
            <Route
              path="/allocations"
              element={protect(<Allocations />, "hr")}
            />

            <Route
              path="/allocations/new"
              element={protect(<AllocationFormPage />, "hr")}
            />

            <Route
              path="/allocations/:id"
              element={protect(<AllocationDetails />, "hr")}
            />
            ...
            <Route
              path="/employees/:employeeId/allocations"
              element={protect(<Allocations />, "hr")}
            />
            ...
            <Route
              path="/me/profile"
              element={protect(<MyProfile />, "employee")}
            />

            <Route
              path="/me/attendance"
              element={protect(<MyAttendance />, "employee")}
            />

            <Route
              path="/me/timeoff"
              element={protect(<MyTimeOff />, "employee")}
            />

            <Route
              path="/me/timeoff/new"
              element={protect(<MyTimeOffForm />, "employee")}
            />

            {/* Payroll */}
            <Route
              path="/payroll/*"
              element={protect(<Payroll />, "payroll")}
            />
          </Routes>
        </main>
      </div>
