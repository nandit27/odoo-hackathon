export default function AttendanceFilterBar({
  ...
  return (
    <div className="grid gap-2 border-b border-slate-200 bg-slate-50/70 p-3 sm:grid-cols-2 sm:px-5 lg:flex lg:flex-wrap lg:items-center">
      <label className="min-w-0 lg:min-w-64 lg:max-w-md lg:flex-1">
      ...
      <label>
        ...
        <select
          ...
          className={`${control} w-full lg:w-44`}
        >
      ...
      <button
        type="button"
        onClick={onClear}
        disabled={!search && !dateFrom && !dateTo && !department && !status}
